...
import { Shield, Plus, History, LogOut, Upload, FileUp, CheckCircle, AlertCircle, Loader2 } from "lucide-react";
      ...
      <aside className="w-72 h-screen bg-sidebar border-r border-sidebar-border flex flex-col">
        ...
        <div className="p-4 border-b border-sidebar-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-sidebar-foreground font-mono tracking-tight">
                DEEPFAKE DETECTOR
              </h1>
              ...
              <div className="space-y-1">
                {history.map((item, idx) => (
                  <motion.button
                    ...
                    onClick={() => hasResults && handleSelectResult(idx)}
