...
export default function FrameTimeline({ timeline }: FrameTimelineProps) {
  ...
  return (
    ...
    >
      <h4 className="text-sm font-mono font-semibold text-foreground mb-1 flex items-center gap-2">
      ...
      <div className="h-48">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={data}>
            ...
            />
            <ReferenceLine y={0.5} stroke="hsl(0 72% 55%)" strokeDasharray="5 5" strokeOpacity={0.5} />
            <Line
              type="monotone"
